                                    ...
                                    <div className="col-md-6 mb-3">
                                        <div className="form-group">
                                            ...
                                            <input type="text" value={address} onChange={(e) => setAddress(e.target.value)} className="form-control"
                                                placeholder="Address" />
                                            {errors.Address && <div className="alert alert-danger mt-2 rounded-4">{errors.Address}</div>}
                                        </div>
                                    </div>
                                    <div className="col-md-6 mb-3">
                                        <div className="form-group">
                                            <label className="mb-1 fw-bold">Phone Number</label>
                                            <input type="text" value={phone} onChange={(e) => setPhone(e.target.value)} className="form-control"
                                                placeholder="Phone Number" />
                                            {errors.Phone && <div className="alert alert-danger mt-2 rounded-4">{errors.Phone}</div>}
                                        </div>
                                    </div>
                                    <div className="mb-3">
                                        <div className="form-group">
